        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3" id="form_container">
                    ...
                    <form role="form" method="post" id="reused_form" action="/contact-form-html-javascript-php/handler.php">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <button type="submit" class="btn btn-lg btn-default pull-right" ><a src=handler.php></a>Send &rarr;</button>
                            </div>
                        </div>
                    </form>
